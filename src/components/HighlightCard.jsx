...
export default function HighlightCard({ coin, onClick }) {
  return (
    <div
      ...
      className="flex items-center justify-between gap-3 p-3 rounded-xl shadow hover:shadow-lg hover:bg-gray-50 cursor-pointer transition-all duration-200 ease-in-out"
    >
